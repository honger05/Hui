...
var moment = window.moment || function() {}

!(function($, moment, CalendarUtil) {
  ...
  var langs = {
    'zh-cn': CalendarUtil.ZH_CN,
    'zh-tw': CalendarUtil.ZH_TW,
    'fr': CalendarUtil.FR,
    'ja': CalendarUtil.JA,
    'en': CalendarUtil.EN
  };
  ...
  CalendarUtil.BaseCalendar = BaseCalendar;

})(jQuery, moment, Hui.CalendarUtil)
...
!(function($, moment, CalendarUtil) {
  ...
  CalendarUtil.BaseColumn = BaseColumn;
...
!(function(Handlebars, CalendarUtil) {

  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};

  CalendarUtil.CalendarTpl = template(function (Handlebars,depth0,helpers,partials,data) {
...
})(Handlebars, Hui.CalendarUtil)


!(function($, moment, CalendarUtil) {

  var BaseColumn = CalendarUtil.BaseColumn;
  ...
  CalendarUtil.DateColumn = DateColumn;
...
!(function($, moment, CalendarUtil) {
  ...
  CalendarUtil.MonthColumn = MonthColumn;
...
!(function($, moment, CalendarUtil) {
  ...
  CalendarUtil.YearColumn = YearColumn;
...
!(function($, moment, CalendarUtil) {
  ...
  var BaseCalendar = CalendarUtil.BaseCalendar;
  var DateColumn = CalendarUtil.DateColumn;
...
!(function($, moment, CalendarUtil) {
  ...
  var BaseCalendar = CalendarUtil.BaseCalendar;
  var DateColumn = CalendarUtil.DateColumn;
  var MonthColumn = CalendarUtil.MonthColumn;
  var YearColumn = CalendarUtil.YearColumn;
  ...
  Calendar.BaseColumn = CalendarUtil.BaseCalendar;
